...
--------------------
01d,04may10,mcm  Fixing compilation error - cast from 'object_t*' to 'int'
                 loses precision.
01c,30jun09,mcm  Fixing signature of main
01b,01oct04,job  Updated to WR docs format
